...
def cli(url, out, file_name):
    ...
    How to use
            downloadEasy https://download.blender.org/peach/bigbuckbunny_movies/BigBuckBunny_320x180.mp4
    ...
    def download_main():
        try:
            ...
            if obj1.file_check(out=out):
                click.echo("File already is there, If File is Incomplaete will start to download remaing files")
            ...
            time.sleep(2)
            click.echo("No internet connection.! Don't Worry When Connection come It will remain continue")
            download_main()
